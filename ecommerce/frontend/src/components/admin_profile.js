...
const AdminProfile = () => {
  ...
  return (
    ...
    <div className='profileContainer m-4'>
      ...
      <span className='AdminSpan'><NavLink className="manage"  to="/manageProduct">Manage Product</NavLink></span>
</button>
<button className='AdminButton'>
    <span className='AdminSpan'><NavLink className="manage"  to="/manageUser">Manage User </NavLink></span>
</button>
<button className='AdminButton'>
    <span className='AdminSpan'> <NavLink  className="manage" to="/manageOrder">Manage Order</NavLink></span>
</button>
</div>
</>
  );
